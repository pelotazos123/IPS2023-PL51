...
create table solicitudesModificacionDatos(id integer PRIMARY KEY AUTOINCREMENT, dni varchar2(255) NOT NULL, name varchar2(255), surname varchar2(255), modificacion varchar2(255));
