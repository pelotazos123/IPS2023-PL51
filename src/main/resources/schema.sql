...
CREATE TABLE IF NOT EXISTS entrenadores_cursillo (id integer PRIMARY KEY AUTOINCREMENT, id_curso int, dni varchar2(255), foreign key(id_curso) REFERENCES cursillos(id));