...
public class Socio {
	...
	public Socio(Database db,int id,String dni, String nombre, String apellidos, String correo, int tel, String iban, String altura, int peso, Generos genero, LocalDate fecha) {
		this.db = db;
		this.id = id;
		this.dni = dni;
		this.nombre = nombre;
