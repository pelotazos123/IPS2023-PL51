...
CREATE TABLE IF NOT EXISTS cursillos (id int PRIMARY KEY AUTOINCREMENT, nombre varchar2(255) UNIQUE,code_instalacion varchar2(255), fecha_inicio date, fecha_fin date, cost real, foreign key(code_instalacion) REFERENCES instalaciones(code));