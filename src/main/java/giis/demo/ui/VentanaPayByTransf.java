...
public class VentanaPayByTransf extends JFrame {

	/**
	 * 
	 */
	private CheckFichero cf;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaPayByTransf frame = new VentanaPayByTransf();
