...
create table reservas (id integer PRIMARY KEY AUTOINCREMENT, fecha_inicio date, fecha_fin date, instalation_code varchar2(255), tipo varchar2(255), FOREIGN KEY(instalation_code) REFERENCES instalaciones(code));
