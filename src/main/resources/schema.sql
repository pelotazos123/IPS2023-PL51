...
create table socios (id int, name varchar2(255),surname varchar2(255), email varchar2(255), cuota_type varchar2(255), iban varchar2(255), height varchar2(255), weight int, age int, gender varchar2(255), directive bool);
