...
create table socios (id int, dni varchar2(255), name varchar2(255),surname varchar2(255), email varchar2(255), cuota_type varchar2(255), iban varchar2(255), height varchar2(255), weight int, birth_date varchar2(255), gender varchar2(255), directive bool);
create table licencias (owner_id int, tutor_name varchar2(255),tutor_surname varchar2(255), tutor_age varchar2(255), tutor_gender varchar2(255), state varchar2(255), price int, licence_type varchar2(255), facturation_direction varchar2(255),facturation_info varchar2(255), foreign key(owner_id) references socios(id));
