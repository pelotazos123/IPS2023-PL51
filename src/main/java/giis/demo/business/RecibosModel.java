...
public class RecibosModel {
	...
	public static final String SQL_GENERATE_RECIBOS = 
			"insert into recibos (owner_iban, number, amount, value_date, charge_date, concept, type_recibo, state) values (?,?,?,?,?,?,?,?)";
	...
	public void generateRecibo(String iban, int number, double amount, String value_date, String charge_date, String concept, String type_recibo, String state) {
		db.executeUpdate(SQL_GENERATE_RECIBOS, iban, number,  amount, value_date, charge_date, concept, type_recibo, state);
	}
