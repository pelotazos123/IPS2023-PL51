...
CREATE TABLE IF NOT EXISTS cursillos (id int, nombre varchar2(255) UNIQUE,code_instalacion varchar2(255), fecha_inicio date, fecha_fin date FOREIGN KEY(code_instalacion) REFERENCES instalaciones(code), PRIMARY KEY(id AUTOINCREMENT));